...
pca = PCA(n_components=6, svd_solver='full')#choose the number of componenets in the final dataset
new_data=pca.fit_transform(data)#fit the pca model to the dataset and store it in a new dataset
