...
classifier=RandomForestClassifier(random_state=226)#obtain the classifier funtion
...
diag_sum=0
for i in range(0,3):
    diag_sum=diag_sum+cm[i,i]#diagonal sum ie the correct preds
total=0
for i in range(0,3):
    for j in range(0,3):
        total=total+cm[i,j]#total preds
